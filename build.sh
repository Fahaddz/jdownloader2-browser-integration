...
zip -r "../jdownloader-interceptor-firefox-v${VERSION}.xpi" .
cd ../..
...
zip -r "../jdownloader-interceptor-chrome-mv2-v${VERSION}.zip" .
cd ../..
...
zip -r "../jdownloader-interceptor-chrome-mv3-v${VERSION}.zip" .
cd ../..
